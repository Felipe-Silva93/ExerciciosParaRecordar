...
public class App extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		Font.loadFont(getClass().getResource("/calculadoraFX/Roboto.ttf").toExternalForm(), 10);
		String css = getClass().getResource("/calculadoraFX/Calculadora.css").toExternalForm();
