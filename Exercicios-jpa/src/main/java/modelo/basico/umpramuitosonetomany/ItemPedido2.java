...
public class ItemPedido2 {
	...
	public ItemPedido2(Pedidos2 pedido, Produto produto, int quantidade) {
		super();
	...
	public final Pedidos2 getPedido() {
		return pedido;
	}

	public final void setPedido(Pedidos2 pedido) {
		this.pedido = pedido;
	}
